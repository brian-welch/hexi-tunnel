...
Shapes[1] = (index, r, g, b) => {
    return `<svg id="hexagon_${index+1}" class="" style="width:${260 - (index+1)}vw; transform: rotate(-${index*1}deg); color: rgba(${Math.floor(r - (index * (r/iterations)))},${Math.floor(g - (index * (g/iterations)))},${Math.floor(b - (index * (b/iterations)))},1)" viewBox="0 0 1199.9996 1199.9996" height="1199.9996mm" width="1199.9996mm">

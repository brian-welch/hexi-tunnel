...
let strokeOpacity = (windowWidth + widonwHeight) < 1400 ? 0.35 : 0.75;
...
Shapes[1] = (index) => {
    ...
    <g transform="translate(323.03455,323.03455)" style="display:inline" id="layer2">
        ...
        style="fill:currentColor;stroke-width:1;stroke-miterlimit:4;stroke-dasharray:none;stroke:rgba(${r_1},${g_1},${b_1},1);stroke-opacity:${strokeOpacity}" />
    </g>    
</svg>`;
}

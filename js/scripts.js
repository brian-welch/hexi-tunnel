...
let iterations = 260, animationSpeed = 35;
...
Shapes[1] = (index, r, g, b) => {
    return `<svg id="hexagon_${index+1}" class="" style="width:${260 - (index+1)}vw; transform: rotate(-${index*1}deg); color: rgba(${Math.floor(r - (index * (r/(iterations+10))))},${Math.floor(g - (index * (g/(iterations+10))))},${Math.floor(b - (index * (b/(iterations+10))))},1)" viewBox="0 0 1199.9996 1199.9996" height="1199.9996mm" width="1199.9996mm">
    <g transform="translate(323.03455,323.03455)" style="display:inline" id="layer2">
        ...
        style="fill:currentColor;stroke-width:1;stroke-miterlimit:4;stroke-dasharray:none;stroke:rgba(${r},${g},${b},0.5);stroke-opacity:1" />
    </g>    
</svg>`;
}

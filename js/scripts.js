...
let dir = ['-', ''], i, windowWidth = $(window).width(), widonwHeight = $(window).height();
...
let r_2 = (0 + (Math.random()*255)),
    g_2 = (0 + (Math.random()*255)),
    b_2 = (0 + (Math.random()*255));
let r_3 = r_2 - 127 < 0 ? r_2 + 127 : r_2 - 127,
    g_3 = g_2 - 127 < 0 ? g_2 + 127 : g_2 - 127,
    b_3 = b_2 - 127 < 0 ? b_2 + 127 : b_2 - 127;
let aspect = windowWidth > widonwHeight ? 0 : 1;
let strokeOpacity = (windowWidth + widonwHeight) < 1400 ? 0.4 : 0.75;
...
Shapes[1] = (index) => {
    ...
    <g transform="translate(323.03455,323.03455)" style="display:inline" id="layer2">
        ...
        style="fill:currentColor;stroke-width:1.25;stroke-miterlimit:4;stroke-dasharray:none;stroke:rgba(${r_3},${g_3},${b_3},1);stroke-opacity:${strokeOpacity}" />
    </g>    
</svg>`;
}
